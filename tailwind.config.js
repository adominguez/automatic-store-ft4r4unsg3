  ...
  theme: {
    extend: {
      colors: {
        ...colors,
        primary: {
            100: lighten('#0097a7', 0.4),
            200: lighten('#0097a7', 0.3),
            300: lighten('#0097a7', 0.2),
            400: lighten('#0097a7', 0.1),
            500: '#0097a7',
            600: darken('#0097a7', 0.1),
            700: darken('#0097a7', 0.2),
            800: darken('#0097a7', 0.3),
            900: darken('#0097a7', 0.4),
        },
        secondary: {

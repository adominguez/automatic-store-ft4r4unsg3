...
const KeywordPage = ({content, name, products, categories, id, productsToCompare, bestProducts = [], interlinking = [], image, tag, video}) => {
	const {comparisonProducts = {}, featureProducts = {}, genericSpintax = {}, linkCategories = {}, productsCatalog = {}, video: videoBlock = {}} = content;

	console.log(interlinking)
